...
if __name__ == '__main__':
    ...
    #Code zum erstellen eines Vorschaubildes
    ...
    #Ein neues Streamobjekt erzeugen
    """Hinweis zur Kameraauswahl:
    Die Kamera wird über die Zahl die im Konstruktor von VideoCamera übergeben wird ausgewählt
    Im Normalfall sollte die eingebaute Webcam entweder über 0 oder 1 gefunden werden.
    """
